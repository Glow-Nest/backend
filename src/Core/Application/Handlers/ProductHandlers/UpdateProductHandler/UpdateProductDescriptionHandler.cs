...
public class UpdateProductDescriptionHandler: ICommandHandler<UpdateProductDescriptionCommand>
{
    ...
    public async Task<Result> HandleAsync(UpdateProductDescriptionCommand command)
    {
